                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                        ...
                        <div className="md:w-1/2 max-w-xl">
                            <span className="inline-block bg-white text-[#E4072F] font-bold text-xs tracking-widest uppercase px-4 py-1.5 rounded-full mb-6 shadow-sm animate-fade-up">
                                Hecho a mano con amor
                            </span>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-[#12192C] leading-tight mb-6 animate-fade-up" style={{ animationDelay: '100ms' }}>
                                Hablemos de tu <br className="hidden md:block" />
                                <span className="text-[#E4072F]">próxima puntada</span>
                            </h1>
                            <p className="text-lg md:text-xl mb-8 font-medium animate-fade-up" style={{ animationDelay: '180ms' }}>
                                ¿Tenés una consulta, querés hacer un pedido o necesitás más información?
                            </p>
                            
                            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up" style={{ animationDelay: '260ms' }}>
                                <a 
                                    href="https://wa.me/123456789" 
                                    className="contact-button inline-flex items-center justify-center gap-2 bg-[#E4072F] text-white px-6 py-3 rounded-full font-bold shadow-md"
                                >
                                ...
                                <a 
                                    ...
                                    className="contact-button inline-flex items-center justify-center gap-2 bg-white text-[#E4072F] border-2 border-[#E4072F] px-6 py-3 rounded-full font-bold shadow-sm"
                                >
                        ...
                        <div className="md:w-1/2 flex justify-center mt-12 md:mt-0">
                            {/* Visual wrapper for Ricky + Balloon */}
            ...
            >
                ...
                <section className="py-20 container mx-auto px-4">
                    ...
                    <div className="flex flex-col md:flex-row justify-center gap-8 max-w-4xl mx-auto">
                        {/* WhatsApp Card */}
                        <div className="contact-card bg-white border border-[#F3D7E4] rounded-[28px] p-8 md:p-10 shadow-sm flex flex-col items-center text-center flex-1 relative group mt-4 md:mt-0 animate-fade-up" style={{ animationDelay: '100ms' }}>
                            {/* Decorative Tape */}
                            ...
                            <a href="https://wa.me/123456789" className="contact-button mt-auto bg-[#E4072F] text-white px-8 py-3 rounded-full font-bold w-full md:w-auto shadow-md">
                                Chatear ahora
                            </a>
                        </div>

                        {/* Instagram Card */}
                        <div className="contact-card bg-white border border-[#F3D7E4] rounded-[28px] p-8 md:p-10 shadow-sm flex flex-col items-center text-center flex-1 relative group mt-4 md:mt-0 animate-fade-up" style={{ animationDelay: '200ms' }}>
                            {/* Decorative Tape */}
                            ...
                            <a href="https://instagram.com/locaspuntadas" className="contact-button mt-auto bg-[#E4072F] text-white px-8 py-3 rounded-full font-bold w-full md:w-auto shadow-md">
                                Ver perfil
                            </a>
                        </div>
                    </div>
                ...
                <section className="py-20 container mx-auto px-4 pb-32">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 max-w-5xl mx-auto">
                        {/* Checklist */}
                        <div className="bg-white border border-[#F3D7E4] rounded-[28px] p-8 md:p-10 shadow-sm flex-1 relative overflow-hidden flex flex-col justify-center animate-fade-up">
                            {/* Background Image */}
                            <div className="absolute inset-0 z-0">
                        ...
                        {/* FAQ */}
                        <div className="bg-white border border-[#F3D7E4] rounded-[28px] p-8 md:p-10 shadow-sm flex-1 animate-fade-up" style={{ animationDelay: '100ms' }}>
